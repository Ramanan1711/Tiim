...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmClearanceList").attr("action","clearanceClosing.jsf");   	                
	          $("#frmClearanceList").submit(); 
	      });
	      ...
	      $("#btnpopup").click(function ()        
 	      {		    	
	    	 ...
	    	 $("#requestId").val("0"); 
	    	 $("#frmClearanceList").attr("action","addIntialToolingRequestNote.jsf");   	                
	         $("#frmClearanceList").submit();
 	      });
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmClearanceList").attr("action","deleteClearanceClosing.jsf");   	                
	          $("#frmClearanceList").submit(); 
   	      });  	        
   	   ...
   	   $("#clearanceNo").keypress(function(e){
 	 	  	  if(e.which == 13)
 	 	  	  {	 	  		
 	 	  		 return funAllList();
 	 	  	  }     	  	 
   ...
   {		
	   $("#requestId").val(id); 
	   $("#frmClearanceList").attr("action","editClearanceClosing.jsf");   	                
	   $("#frmClearanceList").submit();
   }
   ...
   {	 
	   ...
	   window.open('viewClearanceClosing.jsf?requestId='+requestId, 'window', 'width=700,height=750'); 
   }
   ...
   function funAllList()
   {	
	   var searchVal = trim($("#clearanceNo").val());   
	   if(searchVal == "")
  	   {   	
		   $("#clearanceNo").val(0); 
		   showAllListDialog();
 	   ...
 	   {   
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmClearanceList").attr("action","clearanceClosingList.jsf");   	                
 	       $("#frmClearanceList").submit();
  	   }	  
   }
...
<form name="frmClearanceList" id="frmClearanceList" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;CLEARANCE CLOSING</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="clearanceNo" id="clearanceNo" placeholder="Enter Clearance Closing Number"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
		    ...
		    <c:choose>
			<c:when test="${fn:length(lstClearanceDetail) gt 0}">                               
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			      
			     <thead>
			          <tr>
				          <th width="20%">Clearance number</th>
				          <th width="30%"> Date</th>
				          <th width="35%">Closing Number</th>
				          <th width="15%">Action</th>
			          </tr>  
			     </thead> 
			     <tbody>
			        <c:forEach items="${lstClearanceDetail}" var="clearanceDetail" varStatus="row"> 
				           <tr>
				             <td align="center" style="text-align:center;">${clearanceDetail.clearanceNo}</td>
				             <td align="center" style="text-align:center;">${clearanceDetail.clearanceDate}</td>
				             <td align="center" style="text-align:center;">${clearanceDetail.closingNo}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
							<%
								 if("1".equals(editAccess)){
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${clearanceDetail.closingNo}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${clearanceDetail.closingNo}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${clearanceDetail.closingNo}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
