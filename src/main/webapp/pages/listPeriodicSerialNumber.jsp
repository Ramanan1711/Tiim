		     ...
		     <tbody>
		     	<c:forEach items="${lstSerialNumber}" var="lstSerialNumber" varStatus="i">  
		     		<tr>
			             ...
			             <td>
			             <c:choose>
				             <c:when test="${lstSerialNumber.stockFlag == 3}">
				            	 <input type="checkbox" name="approvedQty" class="approvedQty" id="approvedQty${i.index}" value="${lstSerialNumber.serialNumber}" checked> Issue
				             </c:when>
				             <c:otherwise>
				             	<input type="checkbox" name="approvedQty" class="approvedQty" id="approvedQty${i.index}" value="${lstSerialNumber.serialNumber}"> Issue
				             </c:otherwise>
				          </c:choose>
