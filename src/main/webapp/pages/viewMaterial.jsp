					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData">
					         <tr>
					              ...
					              <th align="center" width="8%">Material Type</th>
					              <th align="center" width="8%">Material Code&nbsp;</th>
					              <th align="center" width="8%">Material Name&nbsp;</th>
<!-- 					              <th align="center" width="8%">Minimum Quantity&nbsp;</th>
 -->					              <th align="center" width="8%">UOM </th>
					              <th align="center" width="8%">Minimum Stock Level &nbsp;</th>
					              <th align="center" width="8%">RE Order Level &nbsp;</th>
					         </tr>
					         <c:forEach items="${lstMaterialDetail}" var="materialList" varStatus="row">  
						                 <tr id="rowid">
									          
									          <!-- <td align="center"></td> -->
									          <td align="center">${materialList.materialType}</td>
									          <td align="center">${materialList.materialCode}</td>
									          <td align="center">${materialList.materialName}</td>
<%-- 									          <td align="center">${materialList.materialQty}</td>
 --%>									          <td align="center">${materialList.uom}</td>
									          <td align="center">${materialList.minStockLevel}</td>
									          <td align="center">${materialList.reorderLevel}</td>
							           </tr> 
