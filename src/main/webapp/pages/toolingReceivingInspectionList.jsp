...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#frnToolRecvInsp").attr("action","showAddToolingReceiveInspection.jsf");   	                
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frnToolRecvInsp").attr("action","deleteToolingInspection.jsf");   	                
	          $("#frnToolRecvInsp").submit(); 
   	      });  	        
   ...
   function funedit(id)  
   {		 
	   $("#toolingInspectionId").val(id); 
	   $("#frnToolRecvInsp").attr("action","editToolingReceiveInspection.jsf");   	                
	   $("#frnToolRecvInsp").submit();
   }
   
   function viewReport(requestId)
   {	 
	   var urlvalue= 'viewToolingReceiveInspectionReport.jsf?toolingInspectionId='+requestId;
	   $("#toolingInspectionId").val(requestId); 
	   window.open(urlvalue, 'window', 'width=700,height=750'); 
   }
	   ...
	   if(searchVal == "")
 	   ...
 	   {   
		   $("#toolingInspectionId").val("0"); 
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frnToolRecvInsp").attr("action","searchToolingReceiveInspection.jsf");   	                
 	       $("#frnToolRecvInsp").submit();
  	   }	  
   }
   ...
   {  		    	
	       ...
	       $("#action").val("listdata");  
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();   	 			                    	                  
 	 	   $("#frnToolRecvInsp").attr("action","showToolingReceiveInspection.jsf");   	                
 	       $("#frnToolRecvInsp").submit();	      	 	
   }   	  
</script>
...
RoleVsUser roleVsUser1 = hmRoleVsUser1.get("Receiving Inspection");
if(roleVsUser1 != null)
{
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="25%" class="heading" align="left">&nbsp;New Tool Inspection Report</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="toolingSearch" id="toolingSearch" placeholder="Enter Inspection Report No" value="${toolingSearch}" class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
		  ...
		  <c:choose>
			...
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			     ...
			     <thead>
			          <tr>
				          <th width="20%">Inspection Report No</th>
				          <th width="30%">Inspection Report Date</th>
				          <th width="35%">Request Id</th>
				          <th width="35%">Request Date</th>
			     ...
			     <tbody>
			         <c:forEach items="${lstToolinginsInspections}" var="arlToolInspect" varStatus="row">  
				          <tr>
				             ...
				             <td>${arlToolInspect.requestId}</td>
				             <td>${arlToolInspect.requestDate}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
				                 <%
								  if("1".equals(editAccess)){
								 %>
				             	 <a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${arlToolInspect.toolingInspectionId}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	 <%
								  }else{
				             	 %>
								 ...
								 %>
				             	 <a title="Click to Delete" href="javascript:fundelete('${arlToolInspect.originalId}','${arlToolInspect.toolingInspectionId}');" id="deleteAnchor${row.index}" ><img border="0"  id="delete${row.index}" style="" src="./images/deleteicon.gif"/></a>
				             	 <%
								  }else{
				             	 %>  
								 ...
								 %>
				             	 <a title="Click to Delete" href="javascript:viewReport('${arlToolInspect.toolingInspectionId}');"><img border="0"  id="viewReportImg${row.index}" style="" src="./images/view_report-icon.png"/></a>
				             	 <%
								  }else{
				             	 %>  
				             	 <a title="Access denied" href="#" id="deleteAnchor${row.index}" ><img border="0"  id="viewReportImg${row.index}" style="" src="./images/view_report-icon.png"/></a>
				             	 <%}%>          					
				             </td>
				         </tr>
			         </c:forEach>
