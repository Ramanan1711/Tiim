...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmClearanceNoList").attr("action","showClearance.jsf");   	                
	          $("#frmClearanceNoList").submit(); 
	      });
	      ...
	      $("#btnpopup").click(function ()        
 	      {		    	
	    	 ...
	    	 $("#requestId").val("0"); 
	    	 $("#frmClearanceNoList").attr("action","addIntialToolingRequestNote.jsf");   	                
	         $("#frmClearanceNoList").submit();
 	      });
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmClearanceNoList").attr("action","deleteClearance.jsf");   	                
	          $("#frmClearanceNoList").submit(); 
   	      });  	        
   ...
   {		
	   $("#requestId").val(id); 
	   $("#frmClearanceNoList").attr("action","editClearance.jsf");   	                
	   $("#frmClearanceNoList").submit();
   }
   ...
   {	 
	   ...
	   window.open('viewClearance.jsf?requestId='+requestId, 'window', 'width=700,height=750'); 
   }
   ...
   {	
	   ...
	   if(searchVal == "")
 	   ...
 	   {   
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmClearanceNoList").attr("action","showClearanceList.jsf");   	                
 	       $("#frmClearanceNoList").submit();
  	   }	  
   }
...
<form name="frmClearanceNoList" id="frmClearanceNoList" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;Clearance Number</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="clearanceNo" id="clearanceNo" placeholder="Enter Clearance  Number"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
		    ...
		    <c:choose>
			<c:when test="${fn:length(lstClearanceNoDetail) gt 0}">                               
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			     ...
			     <tbody>
			        <c:forEach items="${lstClearanceNoDetail}" var="clearanceDetail" varStatus="row"> 
				           <tr>
				             ...
				             <td align="center" style="text-align:center;">${clearanceDetail.productName}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
							<%
								 if("1".equals(editAccess)){
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${clearanceDetail.clearanceNo}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${clearanceDetail.clearanceNo}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${clearanceDetail.clearanceNo}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
