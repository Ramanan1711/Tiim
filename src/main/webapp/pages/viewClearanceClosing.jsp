...
<div id="content">
   ...
   <table width="100%" cellspacing="0" cellpadding="5" border="0" align="center"  height="25px">		      
       <tr>  
           <td width="35%" class="heading" align="left">&nbsp;Clearance Closing</td> 
				...
				<c:choose>
					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData">
					         <tr>
					              <th align="center" width="8%">Clearance Number</th>
					              <th align="center" width="8%">Date&nbsp;</th>
   					              <th align="center" width="8%">Product Name&nbsp;</th>
   					              <th align="center" width="8%">Lot Number&nbsp;</th>
   					              <th align="center" width="8%">Batch Number&nbsp;</th>
   					              <th align="center" width="8%">Batch Quantity&nbsp;</th>
					              <th align="center" width="8%">Closing Number&nbsp;</th>
					         </tr>
					         <c:forEach items="${lstClearanceDetail}" var="clearanceDetail" varStatus="row">  
						                 <tr id="rowid">
									        ...
									        <td align="center" style="text-align:center;">${clearanceDetail.lotNumber}</td>
									        <td align="center" style="text-align:center;">${clearanceDetail.batchNumber}</td>
									        <td align="center" style="text-align:center;">${clearanceDetail.batchQty}</td>
