				             ...
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<c:choose>
									<c:when test="${latPlating.active == 1}">
										<a title="Inactive entry can only be deleted" id="deleteAnchor${row.index}"><img border="0" id="delete${row.index}" src="./images/deleteicon_black.gif"/></a>&nbsp;&nbsp;<a title="Click to make this Inactive" href="javascript:funstatus('${latPlating.id}','${row.index}','${latPlating.active}');" id="statusAnchor${row.index}" ><img border="0" id="changeStatus${row.index}" style="" src="./images/activate.gif"/></a>
									</c:when>
