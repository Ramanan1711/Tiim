...
<head>
	...
	<title>Cleaning SOP Report</title>
		...
		<div class="wide column">
			...
			<div class="ui segment">
				...
				<form class="ui form">
					...
					<h4 class="ui dividing header">Cleaning SOP Report</h4>
				...
				<c:choose>
					<c:when test="${fn:length(lstReturnNote) gt 0}">
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData" border="1">
					         ...
					         <c:forEach items="${lstReturnNote}" var="lstReturnNote" varStatus="row">  
						       <tr id="rowid">
								    <td align="center" style="text-align:center;">${lstReturnNote.productName1}</td>
						             <td align="center" style="text-align:center;">${lstReturnNote.machineName1}</td>
						             <td align="center" style="text-align:center;">${lstReturnNote.typeOfTooling1}</td>
						             <td align="center" style="text-align:center;">${lstReturnNote.drawingNo1}</td>
						             <td align="center" style="text-align:center;">${lstReturnNote.toolingLotNumber1}</td>
   						             <td align="center" style="text-align:center;">${lstReturnNote.lastInspectionDate1}</td>
							   </tr> 
							 </c:forEach>
