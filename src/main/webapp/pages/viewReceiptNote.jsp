...
<div id="content">
   ...
   <table width="100%" cellspacing="0" cellpadding="5" border="0" align="center"  height="25px">		      
       <tr>  
           <td width="35%" class="heading" align="left">&nbsp;Receipt Note</td> 
         ...
         <DIV STYLE="width: 99%; padding:0px; margin: 0px;height:auto;min-height:auto;" class="content">
             ...
             <table class="spacerwht"  border="0" cellspacing="0" cellpadding="0"  align="center">
				...
				<table style="width:80%" align="left" cellpadding="3" cellspacing="0" border="0">		
					<tr>
						<td></td>
						<td  class="formlabelblack" align="left">&nbsp;&nbsp;Receipt No&nbsp;</td>						
						<td   align="left">${receiptNote.toolingReceiptId}</td>		
						<td class="formlabelblack" align="left">&nbsp;&nbsp;&nbsp;Receipt Date</td>
					    <td class="popuplabel" align="left">${receiptNote.grnDate}</td>										
					</tr>	
					<tr>
						<td></td>
						<td class="formlabelblack" align="left">&nbsp;&nbsp;Supplier Code</td>						
						<td align="left">${receiptNote.supplierCode}</td>				
						<td class="formlabelblack" align="left">&nbsp;&nbsp;&nbsp;Supplier Name</td>
					    <td class="popuplabel" align="left">${receiptNote.supplierName}</td>		
					</tr>
				</table>
             ...
             <table cellspacing="0" width="99%" cellpadding="5" border="0" align="center" height="30px">		      
				...
				<c:choose>
					<c:when test="${fn:length(lstReceiptNote) gt 0}">
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData">
					         <tr>
					              ...
					              <th align="center" width="8%">Order Quantity</th>
					              <th align="center" width="8%">Received Quantity</th>
						         <th align="center" width="8%">Min Accepted Qnty</th>        
					                
					         </tr>
					         <c:forEach items="${lstReceiptNote}" var="lstReceiptNote" varStatus="row">  
						                 <tr id="rowid">
									          
									          <!-- <td align="center"></td> -->
									          <td align="center">${lstReceiptNote.productName}</td>
									          <td align="center">${lstReceiptNote.drawingNo}</td>
									          <td align="center">${lstReceiptNote.machineType}</td>
									          <td align="center">${lstReceiptNote.typeOfTool}</td>
									          <td align="center">${lstReceiptNote.toolingLotNumber}</td>
									          <td align="center">${lstReceiptNote.poQuantity}</td>		          
											  <td align="center">${lstReceiptNote.receivedQuantity}</td>
											  <td align="center">${lstReceiptNote.minAcceptedQty}</td>
