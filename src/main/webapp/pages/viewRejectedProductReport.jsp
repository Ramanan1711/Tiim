...
<head>
	...
	<title>Rejected Product Report</title>
		...
		<div class="wide column">
			...
			<div class="ui segment">
				...
				<form class="ui form">
					...
					<h4 class="ui dividing header">Rejected Product Report</h4>
					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData" border="1">
					         <tr>
    						      ...
    						      <th align="center" width="15%">Serial Number</th>
						          <th align="center" width="15%">Rejected In</th>
					         </tr>
					         <c:forEach items="${lstProductReport}" var="lstProductReport" varStatus="row">  
						       <tr id="rowid">
								    <td align="center" style="text-align:center;">${lstProductReport.toolingId}</td>
						             <td align="center" style="text-align:center;">${lstProductReport.productName}</td>
						             <td align="center" style="text-align:center;">${lstProductReport.machineName}</td>
						             ...
						             <td align="center" style="text-align:center;">${lstProductReport.lotNumber}</td>
   						             ...
   						             <td align="center" style="text-align:center;">${lstProductReport.source}</td>
