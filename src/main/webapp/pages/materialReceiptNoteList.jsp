...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmMaterialReceiptList").attr("action","showMaterialReceipt.jsf");   	                
	          $("#frmMaterialReceiptList").submit(); 
	      });
	      ...
	      $("#btnpopup").click(function ()        
 	      {		    	
	    	 ...
	    	 $("#requestId").val("0"); 
	    	 $("#frmMaterialReceiptList").attr("action","addIntialToolingRequestNote.jsf");   	                
	         $("#frmMaterialReceiptList").submit();
 	      });
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmMaterialReceiptList").attr("action","deleteMaterialReceipt.jsf");   	                
	          $("#frmMaterialReceiptList").submit(); 
   	      });  	        
   	   ...
   	   $("#materialGrnNo").keypress(function(e){
 	 	  	  if(e.which == 13)
 	 	  	  {	 	  		
 	 	  		 return funAllList();
 	 	  	  }     	  	 
   ...
   {		
	   $("#requestId").val(id); 
	   $("#frmMaterialReceiptList").attr("action","editMaterialReceipt.jsf");   	                
	   $("#frmMaterialReceiptList").submit();
   }
   ...
   {	 
	   ...
	   window.open('viewMaterialReceipt.jsf?requestId='+requestId, 'window', 'width=700,height=750'); 
   }
   ...
   function funAllList()
   {	
	   var searchVal = trim($("#materialGrnNo").val());   
	   if(searchVal == "")
  	   {   	
		   $("#materialGrnNo").val(0); 
		   showAllListDialog();
 	   ...
 	   {   
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmMaterialReceiptList").attr("action","showMaterialReceiptLst.jsf");   	                
 	       $("#frmMaterialReceiptList").submit();
  	   }	  
   }
...
<form name="frmMaterialReceiptList" id="frmMaterialReceiptList" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;Material Receipt Note</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="materialGrnNo" id="materialGrnNo" placeholder="Enter Grn No"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
			        ...
			        <c:forEach items="${lstMaterialRcptDetail}" var="receiptDetail" varStatus="row"> 
				           <tr>
							...
							<%
								...
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${receiptDetail.materialGrnNo}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${receiptDetail.materialGrnNo}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${receiptDetail.materialGrnNo}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
