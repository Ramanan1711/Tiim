...
$(document).ready(function(){ 
	 $('.tableHeading').fixheadertable({
     	   caption     : '', 
     	  caption     : '', 
          colratio    : [150, 120, 120, 180, 120, 180, 100, 120, 180, 100, 120, 180, 100], 
          height      : 350, 
          width       : 970,             
          sortable    : true, 
          sortedColId : 0,    
 ...
 function processInspection(val)
 {
     ...
     else
     {
		 ...
		 if(val == "Save")
		 {
		 	$("#frmStockIssue").attr("action","addPeriodicInspection.jsf");   
		 }
		 else
		 {
			$("#frmStockIssue").attr("action","updatePeriodicInspection.jsf");
		 }
...
<div id="overlay" class="web_dialog_overlay" ></div>
   ...
   <table width="100%" cellspacing="0" cellpadding="5" border="0" align="center"  height="25px">		      
       <tr>  
           <td width="35%" class="heading" align="left">&nbsp;Purchase Intent Confirmation</td> 
         ...
         <DIV STYLE="width: 99%; padding:0px; margin: 0px;height:auto;min-height:auto;" class="content">
             ...
             <table class="spacerwht"  border="0" cellspacing="0" cellpadding="0"  align="center">
				...
				<table style="width:70%" align="left" cellpadding="3" cellspacing="0" border="0">		
					<tr>
						<td width="30%" class="tabpopuplabel" align="left">&nbsp;Purchase Indent Confirmation</td>
						<td class="formlabelblack" align="left">Confirmation No.&nbsp;<span class="formlabel">*</span></td>
						<td class="formlabelblack" align="left">Confirmation Date&nbsp;<span class="formlabel">*</span></td>			        	        			       	       
					</tr>
					<tr>
					    <td></td>
						<td class="popuplabel" align="left"><input  type="text" name="confirmationNo" id=confirmationNo class="textmin" value="${confirmationNo}"   onkeypress="return funTypeRequestNo(event,this);"autofocus autoComplete="off"/></td>
						<td class="popuplabel" align="left"><input id="confirmationDate" type="text" name="confirmationDate" class="textmin" value="${confirmationDate}"  maxlength="15" autoComplete="off" style="text-align:left;BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove; FONT-SIZE: 10pt;BORDER-LEFT: black 1px groove; BORDER-BOTTOM: black 1px groove; FONT-FAMILY: Tahoma;TEXT-DECORATION: none; background-color:#DDDDDD;" readonly/></td>
					</tr>		     			
             ...
             <table cellspacing="0" width="98%" cellpadding="5" border="0" align="center" height="30px">		      
				...
				<table class="tableHeading" style="width:96%" align="center" id="periodicData">
		         <tr>
		              ...
		              <th align="center" width="10%">Confirmation</th>
		              <th align="center" width="10%">PO Ref No</th>
		              <th align="center" width="10%">Supplier&nbsp;Name</th>
		              <th align="center" width="10%">Expected&nbsp;Del Date</th>
		         ...
		         <c:choose>
				    <c:when test="${action eq 'new'}">       
				       <tr id="rowid-1">
					      ...
					      <td align="center"><input type="text" name="toolinglotnumber" id="toolinglotnumber1" class="textverysmall"  value="" onkeydown="javascript:funToolingLotNo(event,this);"  onkeyup="javascript:funFillStockDetails(event,this);" maxlength="10" autocomplete="off"/><span style="display:none;" id="txtToolingLotNo1" ></span></td>
						  ...
						  <td align="center"><font id="txtProducedQty1"></font></td>
						 
						  <td align="center"><input type="text" name="toolingStatus" id="toolingStatus1" class="textverysmall"  value="" onkeyup="javascript:funToolingDueQty(event,this);" maxlength="5" autocomplete="off"/><span style="display:none;" id="txtToolingStatus1"></span></td>
						  <td align="center"><font id="txtConfirmation1"></font></td>
						  <td align="center"><font id="txtPoRefNo1"></font></td>
						  <td align="center"><font id="txtSupplierName1"></font></td>
						  <td align="center"><font id="txtExpectedDelDate1"></font></td>
								...
								<c:when test="${fn:length(lstStockTransfer) gt 0}">
									...
									<c:forEach items="${lstStockTransfer}" var="stockTransfer" varStatus="row">  	
									    <tr id="rowid-<%=index%>" >
								          ...
								          <td align="center"><input type="text" name="toolinglotnumber" id="toolinglotnumber<%=index%>" class="textverysmall"  value="${stockTransfer.lotNumber}" onkeydown="javascript:funToolingLotNo(event,this);"  onkeyup="javascript:funFillStockDetails(event,this);" maxlength="10" autocomplete="off"/><span style="display:none;" id="txtToolingLotNo<%=index%>" >${stockTransfer.lotNumber}</span></td>
										  ...
										  <td align="center"><font id="txtUom<%=index%>" ></font>${stockTransfer.producedQty}</td>
										  
										  <td align="center">
										  		<input type="text" name="toolingStatus" id="toolingStatus1" class="textverysmall"  value="${stockTransfer.toolingStatus}" onkeyup="javascript:funToolingDueQty(event,this);" maxlength="5" autocomplete="off"/><span style="display:none;" id="txtTransferQty<%=index%>">${stockTransfer.toolingStatus}</span>
										  </td>
										   <td align="center"><font id="txtConfirmation<%=index%>" >${stockTransfer.confirmation}</font></td>				  
										  <td align="center"><font id="txtPoRefNo<%=index%>" >${stockTransfer.poRefNo}</font></td>	
										  <td align="center"><font id="txtSupplierName<%=index%>" ></font>${stockTransfer.supplierName}</td>			  
										  <td align="center"><font id="txtExpectedDelDate<%=index%>" ></font>${stockTransfer.expectedDelDate}</td>
								          <%
								           if(index == 1)
								           {
								          %> 
