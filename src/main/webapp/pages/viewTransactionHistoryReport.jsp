...
<script>
   ...
   {		 
	   	...
	   	}else
	   	{
			...
			if(!$("#allTransaction").prop('checked'))
			{
				allTransaction = "";
			}
			if(!$("#receivedTransaction").prop('checked'))
			{
				receivedTransaction = "";
			}
			if(!$("#productionTransaction").prop('checked'))
			{
				productionTransaction = "";
			}
			if(!$("#periodicTransaction").prop('checked'))
			{
				periodicTransaction = "";
			}
			 $("#frmProductReport").attr("action","getProductHistory.jsf");   	                
	    ...
	    <tr>
	       <td>
			  <table style="width:98%" align="center" cellpadding="4" cellspacing="0" border="0">	     
			     <tr>
			        <td align="left" width="50%" class="popuptoptitle">Transaction History Report</td>
			        <td width="48" class="popuptoptitle" align="right"></td>
			     </tr>			     			     			    
			    
			     <tr>
			        <td align="left" class="formlabelblack">Tooling Lot Number&nbsp;<span class="formlabel">*</span></td>
