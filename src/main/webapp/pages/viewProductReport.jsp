...
<script>
   ...
   {		 
		 ...
		 $.ajax({
	         type: "POST", 
	         url: "${pageContext.request.contextPath}/viewProductReport.jsf", 
	         data: {productName:productName,machine:machine,lotNumber:lotNumber,typeOfTool:typeOfTool,drawingNumber:drawingNumber},
	         success: function(data) {
	        	window.open(data); 
	         }
       });   */
		 
	   $("#frmProductReport").attr("action","viewProductReport1.jsf");   	                
	    ...
	    <tr>
	       <td>
			  <table style="width:98%" align="center" cellpadding="4" cellspacing="0" border="0">	     
			     <tr>
			        <td align="left" width="50%" class="popuptoptitle">Product Report</td>
