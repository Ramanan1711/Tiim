...
<%@ include file="tiimMenu.jsp"%>
					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData" border="1">
					         <tr>
						          ...
						          <th width="15%">Service Interval Quantity</th>
						          <th width="15%">Drawing Number</th>
						          <th width="15%">Produced Quantity</th>	
   						          <th width="20%">Life Percentage</th>
  ...
  <div style="border-width: 2px; padding: 1em; font-size:50%;line-height: 1.5em;" id="fromHTMLtestdiv">
...
<c:when test="${fn:length(lstProductReport) gt 0}">
  <tr>
					              ...
					              <th width="10%">ProductName</th>
						          <th width="10%">Machine Type</th>
    						      <th width="12%">Type of Tool</th>
    						      <th width="12%">Lot Number</th>
    						      <th width="12%">Tooling Life</th>
						          <th width="12%">Service Interval Quantity</th>
						          <th width="12%">Drawing Number</th>
						          <th width="12%">Produced Quantity</th>	
   						          <th width="12%">Life&nbsp;Percentage</th>
