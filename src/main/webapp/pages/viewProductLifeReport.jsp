...
<script>
   ...
   {		 
	  // var serviceInterval = $("#serviceInterval").val();
		 ...
		 $.ajax({
	         type: "POST", 
	         url: "${pageContext.request.contextPath}/viewProductLifeReport.jsf",
		 ...
		 var serviceInterval = $("#serviceInterval").val();
		    ...
		    $("#frmProductReport").attr("action","viewProductLifeReport.jsf");   	                
	    ...
	    <tr>
	       <td>
			  <table style="width:98%" align="center" cellpadding="4" cellspacing="0" border="0">	     
			     <tr>
			        <td align="left" width="50%" class="popuptoptitle">Tooling Life Status Report</td>
			        <td width="48" class="popuptoptitle" align="right"></td>
			     </tr>			     			     			    
			    			  
			     <tr>
			        <td align="left" class="formlabelblack">Percentage of Life&nbsp;<span class="formlabel">*</span></td>
			        <td align="left" class="formlabelblack">&nbsp;<input  type="text" class="textsmall" name="serviceInterval" id="serviceInterval" />
			        <input  type="hidden" class="textsmall" name="percentage" id="percentage" />
			        </td>
			     </tr>     	   		
			     <tr>
