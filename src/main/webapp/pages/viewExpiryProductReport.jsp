...
<head>
	...
	<title>Expired Product Report</title>
		...
		<div class="wide column">
			...
			<div class="ui segment">
				...
				<form class="ui form">
					...
					<h4 class="ui dividing header">Expired Product Report</h4>
				...
				<c:choose>
					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData" border="1">
					         <tr>
					              <th align="center" width="10%">Issue Number</th>
    						      ...
    						      <th align="center" width="15%">Expire Date</th>
						          
					         </tr>
					         <c:forEach items="${lstProductReport}" var="lstProductReport" varStatus="row">  
						       <tr id="rowid">
								    <td align="center" style="text-align:center;">${lstProductReport.toolingReceiptId}</td>
						             ...
						             <td align="center" style="text-align:center;">${lstProductReport.toolingLotNumber}</td>
   						             <td align="center" style="text-align:center;">${lstProductReport.expiryDates}</td>
