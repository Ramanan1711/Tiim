...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmMaterialReturnList").attr("action","showMaterialReturn.jsf");   	                
	          $("#frmMaterialReturnList").submit(); 
	      });
	      ...
	      $("#btnpopup").click(function ()        
 	      {		    	
	    	 ...
	    	 $("#requestId").val("0"); 
	    	 $("#frmMaterialReturnList").attr("action","addIntialToolingRequestNote.jsf");   	                
	         $("#frmMaterialReturnList").submit();
 	      });
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmMaterialReturnList").attr("action","deleteMaterialReturn.jsf");   	                
	          $("#frmMaterialReturnList").submit(); 
   	      });  	        
   ...
   {		
	   $("#requestId").val(id); 
	   $("#frmMaterialReturnList").attr("action","editMaterialReturn.jsf");   	                
	   $("#frmMaterialReturnList").submit();
   }
   ...
   {	 
	   ...
	   window.open('viewMaterialReturn.jsf?requestId='+requestId, 'window', 'width=700,height=750'); 
   }
   ...
   function funAllList()
   {	
	   var searchVal = trim($("#returnNo").val());   
	   if(searchVal == "")
  	   {   	
		   $("#returnNo").val(0); 
		   showAllListDialog();
 	   ...
 	   {   
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmMaterialReturnList").attr("action","showMaterialReturnLst.jsf");   	                
 	       $("#frmMaterialReturnList").submit();
  	   }	  
   }
...
<form name="frmMaterialReturnList" id="frmMaterialReturnList" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;Material Return</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="returnNo" id="returnNo" placeholder="Enter Return No"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
		    ...
		    <c:choose>
			<c:when test="${fn:length(lstMaterialReturnDetail) gt 0}">                               
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			     ...
			     <tbody>
			        <c:forEach items="${lstMaterialReturnDetail}" var="returnDetail" varStatus="row"> 
				           <tr>
				             <td align="center" style="text-align:center;">${returnDetail.returnNo}</td>
				             <td align="center" style="text-align:center;">${returnDetail.returnDate}</td>
				             <td align="center" style="text-align:center;">${returnDetail.materialName}</td>
				             <td align="center" style="text-align:center;">${returnDetail.materialCode}</td>
				             <td align="center" style="text-align:center;">${returnDetail.materialType}</td>
				             <td align="center" style="text-align:center;">${returnDetail.returnBy}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
							<%
								 if("1".equals(editAccess)){
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${returnDetail.returnNo}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${returnDetail.returnNo}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${returnDetail.returnNo}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
