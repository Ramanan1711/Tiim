...
<div id="content">
   ...
   <table width="100%" cellspacing="0" cellpadding="5" border="0" align="center"  height="25px">		      
       <tr>  
           <td width="35%" class="heading" align="left">&nbsp;Material Return</td> 
					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData">
					         <tr>
    						      ...
    						      <th width="15%">Returnd By</th>
    						      <th width="15%">Material Type</th>
    						      <th width="15%">Tool Issue Number</th>
						       ...
						       <tr id="rowid">
								    <td align="center" style="text-align:center;">${returnDetail.returnNo}</td>
						             ...
						             <td align="center" style="text-align:center;">${returnDetail.materialType}</td>
						   		     <td align="center" style="text-align:center;">${returnDetail.toolIssueNo}</td>
						             <td align="center" style="text-align:center;">${returnDetail.lotNumber}</td>
   						             ...
   						             <td align="center" style="text-align:center;">${returnDetail.materialQty}</td>
						             <td align="center" style="text-align:center;">${returnDetail.uom}</td>
						             <td align="center" style="text-align:center;">${returnDetail.remark}</td>
							   </tr> 
							 </c:forEach>
