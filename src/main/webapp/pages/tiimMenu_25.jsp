 ...
 <tr>
	...
	<ul>
	  <li style="<%=isShowMaster%>">
		<a href="#">Masters<span class="crparrow"></span></a>
			<ul>
				...
				<li style="<%=showMstUserMapping%>"><a href="./mstCleaningSop.jsf">SOP</a></li>
				<%
					if("1".equalsIgnoreCase(indent))
					{
				%>
				<li style="<%=showMstUserMapping%>"><a href="./showIndent.jsf">Indent</a></li>
				<%
					}
				%>
				<li style="<%=showMstUserMapping%>"><a href="./issueAcknowledge.jsf">Issue Acknowledge</a></li>
				<li style="<%=showMstUserMapping%>"><a href="./returnAcknowledge.jsf">Return Acknowledge</a></li>
				<%
					if("1".equalsIgnoreCase(clearance))
					{
				%>
				<li style="<%=showMstUserMapping%>"><a href="./showClearanceList.jsf">Clearance Number</a></li>
				<li style="<%=showMstUserMapping%>"><a href="./clearanceClosingList.jsf">Clearance Closing</a></li>
				<%
					}				
				%>
				<li style="<%=showMstUserMapping%>"><a href="./lotToolDestructionList.jsf">Lot Tool Destruction</a></li>
				...
				<li style="<%=showMstUserMapping%>"><a href="mstMaterial.jsf">Material Master</a></li>
				</ul>				
	  </li>
	  ...
	  <li style="<%=isShowProduction%>">
		 <a href="#">Production<span class="crparrow"></span></a>
		 <ul>
	  ...
	  <li style="<%=isShowStore%>">
		<a href="#">Tool Stores<span class="crparrow"></span></a>
			<ul>
				...
				<li style=""><a href="./showMaterialReceiptLst.jsf">Material Receipt Note</a></li>
				<li style=""><a href="./showMaterialIssueLst.jsf">Material Issue</a></li>
			   <li style=""><a href="./showMaterialReturnLst.jsf">Material Return</a></li>
			</ul>		  
	  </li>
	  ...
	  <li >
		 ...
		 <ul>
		 		...
		 		<li style="<%=showProductLifeReport%>"><a href="./showPendingToolingRequest.jsf">Pending Indents from Production Report</a></li>
		 		...
		 		<li style="<%=showProductLifeReport%>"><a href="./createMaterialStockReport.jsf">Material Stock Report</a></li>
		 </ul>
	  </li>
	  <li class="single-link">
		 <a href="#">Help</a>
