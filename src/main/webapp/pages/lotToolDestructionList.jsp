...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmLotToolDestruction").attr("action","lotToolDestruction.jsf");   	                
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmLotToolDestruction").attr("action","deleteLotToolDestruction.jsf");   	                
	          $("#frmLotToolDestruction").submit(); 
   	      });  	        
   ...
   function funedit(id)  
   {		 
	   $("#lotDestruction").val(id); 
	   $("#frmLotToolDestruction").attr("action","editLotToolDestruction.jsf");   	                
	   $("#frmLotToolDestruction").submit();
   }
   
   function viewReport(requestId)
   {	 
	   $("#lotDestruction").val(requestId); 
	   window.open('viewLotToolDestruction.jsf?lotDestruction='+requestId, 'window', 'width=700,height=750'); 
   }
   ...
   function funAllList()
   {	
	   var searchVal = trim($("#lotDestruction").val());   
	   if(searchVal == "")
  	   {   	
...
<form name="frmLotToolDestruction" id="frmLotToolDestruction" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;Lot wise Tool Destruction</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="lotDestruction" id="lotDestruction" placeholder="Enter Destruction number"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
			...
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			     ...
			     <thead>
			          <tr>
				          ...
				          <th>Destruction note number</th>
				          <th>Destroyed By</th>
				          <th>Action</th>
			          </tr>  
			     </thead> 
			     <tbody>
			       <c:forEach items="${lstLotToolDestructionDetail}" var="toolDestructionDetail" varStatus="row">
				          <tr>
				             <td align="center" style="text-align:center;">${toolDestructionDetail.lotDestruction}</td>
				             <td align="center" style="text-align:center;">${toolDestructionDetail.destructionNo}</td>
				         	 <td align="center" style="text-align:center;">${toolDestructionDetail.destroyedBy}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<%
								 if("1".equals(editAccess)){
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${toolDestructionDetail.lotDestruction}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${toolDestructionDetail.lotDestruction}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${toolDestructionDetail.lotDestruction}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
