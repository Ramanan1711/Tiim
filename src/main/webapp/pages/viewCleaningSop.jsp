				...
				<c:choose>
					...
					<div class="table-responsive">
					        <table class="table table-bordered" style="width:98%" align="center" id="cylinderFieldData">
					         ...
					         <c:forEach items="${lstSopDetail}" var="sopList" varStatus="row">  
						                 <tr id="rowid">
									          
									          <!-- <td align="center"></td> -->
									          <td align="center">${sopList.serialNo}</td>
									          <td align="center">${sopList.cleaningtype}</td>
									          <td align="center">${sopList.description}</td>
									          <td align="center">${sopList.cleaningprocess[row.index]}</td>
							           </tr> 
