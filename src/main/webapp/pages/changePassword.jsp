...
<script>
 ...
 {  
	 ...
	 $("#curentPassword").keyup(function(e){   
		 removemsg();
	 });
 ...
 {
	 var alertCrntPwd = "Current Password is required";
     ...
     var password = trim($("#curentPassword").val());
     ...
     else if (hidPwd != password)
     {
    	 if($("#msg").text() == "")
         {
        	 $("#msg").append(invalidPwd);
         }
    	 $("#curentPassword").focus();
    	 return false; 
     }
     ...
     else if(newPassword.toLowerCase().indexOf(userName) >= 0)
     {
    	 ...
    	 $("#frmChangePassWord").attr("action","changePassword.jsf");                 
    	 $("#frmChangePassWord").submit();
     }
     else
     {
...
<%@ include file="tiimMenu.jsp"%>
 ...
 <div id="initialloading" style=" position: absolute; z-index: 700;top:105px; left: 405px; width: 450px; height: 50px; background-color:#ffffff;">
     ...
     <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  height="30px">		      
	     <tr>  
	          <td width="25%" class="heading" align="left">&nbsp;Change Password</td> 
			    ...
			    <tr>
			       <td width="55%" align="left">
			            ...
			            <table border="0" cellspacing="0" width="80%" cellpadding="0"  align="center">
						   <tr>
						       <td width="55%" align="left" valign="top" class="infoheader">Change Your Password</td>						      
					       </tr>
					       <tr height="90px;">
					       ...
					       <tr>
						       ...
						       <td align="left">
						           <table width="100%" cellpadding="4" cellspacing="2" border="0" align="center" style="background-color:#F6F6F6;" >
						              ...
						              <tr>
						                  <td  align="left" class="grayBgLabel">Current Password&nbsp;<span class="grayBgLabelMandatory">*</span></td>	              
						              </tr>	   
						              <tr>
						                 <td align="left" class="popuplabel"><input type="password" name="curentPassword" class="textavg" id="curentPassword" value="" maxlength="20"/></td>
						              </tr> 
						              <tr height="10px">
						              ...
						              <tr>
						                 <td align="left" class="popuplabel"><input type="password" name="confirmNewPassword" class="textavg" id="confirmNewPassword" value="" maxlength="50"/></td>
						              </tr> 
						              <tr height="10px">
						                 <td align="left" class="popuplabel"></td>
						              </tr>  						               
