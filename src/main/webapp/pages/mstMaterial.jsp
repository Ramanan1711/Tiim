...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {	
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmMaterialList").attr("action","showMaterial.jsf");   	                
	          $("#frmMaterialList").submit(); 
	      });
	      ...
	      $("#btnpopup").click(function ()        
 	      {		    	
	    	 ...
	    	 $("#requestId").val("0"); 
	    	 $("#frmMaterialList").attr("action","addIntialToolingRequestNote.jsf");   	                
	         $("#frmMaterialList").submit();
 	      });
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmMaterialList").attr("action","deleteMaterial.jsf");   	                
	          $("#frmMaterialList").submit(); 
   	      });  	        
   ...
   {		 
	   $("#requestId").val(id); 
	   $("#frmMaterialList").attr("action","editMaterial.jsf");   	                
	   $("#frmMaterialList").submit();
   }
   ...
   {	 
	   ...
	   window.open('viewMaterial.jsf?requestId='+requestId, 'window', 'width=700,height=750'); 
   }
	   ...
	   if(searchVal == "")
 	   ...
 	   {   
		   $("#requestId").val("0"); 
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmMaterialList").attr("action","mstMaterial.jsf");   	                
 	       $("#frmMaterialList").submit();
  	   }	  
   }
...
<form name="frmMaterialList" id="frmMaterialList" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;Material Master</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="serialNo" id="searchRequestBy" placeholder="Enter Material code"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
		    ...
		    <c:choose>
			<c:when test="${fn:length(lstMaterialDetail) gt 0}">                             
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			     ...
			     <thead>
			          <tr>
				          ...
				          <th width="35%">Material Type</th>
				          <th width="15%">Action</th>
			          </tr>  
			     </thead> 
			     <tbody>
			        <c:forEach items="${lstMaterialDetail}" var="lstMaterialDetail" varStatus="row">
				          <tr>
				             <td align="center" style="text-align:center;">${lstMaterialDetail.materialName}</td>
				             <td align="center" style="text-align:center;">${lstMaterialDetail.materialCode}</td>
				             <td align="center" style="text-align:center;">${lstMaterialDetail.materialType}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
							<%
								 if("1".equals(editAccess)){
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${lstMaterialDetail.materialCode}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${lstMaterialDetail.materialCode}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${lstMaterialDetail.materialCode}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
