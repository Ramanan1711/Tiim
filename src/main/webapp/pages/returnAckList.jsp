 ...
 */
	   ...
	   if(searchVal == "")
 	   ...
 	   {   
 		   ...
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmReturnAcknowledge").attr("action","returnAcknowledge.jsf");   	                
 	       $("#frmReturnAcknowledge").submit();
  	   }	  
   }
   ...
   {  		    	
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();   	 			                    	                  
 	 	   $("#frmReturnAcknowledge").attr("action","addReturnAcknowledged.jsf");   	                
 	       $("#frmReturnAcknowledge").submit();	      	 	
   }   	
...
<form name="frmReturnAcknowledge" id="frmReturnAcknowledge" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="35%" class="heading" align="left">&nbsp;Tool Return Acknowledgement</td> 
	...
	<center>           
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <c:choose>
			<c:when test="${fn:length(lstReturn) gt 0}">
		        ...
		        <table cellpadding="0" cellspacing ="0" border="0" align="right"  width="100%" >
					 <tr>
						 <td height="5px" align="right">&nbsp;<input type="button" onclick="addAcknowledged()" value="Acknowledge" class="btn btnSMImportant"/>&nbsp;&nbsp;&nbsp;
			...
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading" align="center">
			     ...
			     <tbody>
			          <c:forEach items="${lstReturn}" var="lstReturn" varStatus="row">
			         	  
				          <tr>
				             <td>${lstReturn.originalId}</td> 
				             <td>${lstReturn.productName1}</td>   
				             <td>${lstReturn.machineName1}</td>
				             <td>${lstReturn.drawingNo1}</td>
				             <td>${lstReturn.toolingLotNumber1}</td>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				             	<input type="checkbox" name="acknowledgeId" id="acknowledge${row.index}" value="${lstReturn.originalId}" />
