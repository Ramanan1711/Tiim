...
$("#empCode").val("");  
   ...
   $(document).ready(function ()
    {	  	
	      ...
	      {			      	    	  
	    	  ...
	    	  $("#requestId").val("0"); 
	    	  $("#frmMaterialIssueList").attr("action","showMaterialIssue.jsf");   	                
	          $("#frmMaterialIssueList").submit(); 
	      });
	      ...
	      $("#btnpopup").click(function ()        
 	      {		    	
	    	 ...
	    	 $("#requestId").val("0"); 
	    	 $("#frmMaterialIssueList").attr("action","addIntialToolingRequestNote.jsf");   	                
	         $("#frmMaterialIssueList").submit();
 	      });
	      ...
	      $("#btndelno").click(function ()      
   	      ...
   	      {		    	   	    	  	    			    		    		    	  
	    	  ...
	    	  $("#frmMaterialIssueList").attr("action","deleteMaterialIssue.jsf");   	                
	          $("#frmMaterialIssueList").submit(); 
   	      });  	        
   ...
   {		
	   $("#requestId").val(id); 
	   $("#frmMaterialIssueList").attr("action","editMaterialIssue.jsf");   	                
	   $("#frmMaterialIssueList").submit();
   }
   ...
   {	 
	   ...
	   window.open('viewMaterialIssue.jsf?requestId='+requestId, 'window', 'width=700,height=750'); 
   }
   ...
   function funAllList()
   {	
	   var searchVal = trim($("#issueNo").val());   
	   if(searchVal == "")
  	   {   	
		   $("#issueNo").val(0); 
		   showAllListDialog();
 	   ...
 	   {   
 		   ...
 		   $("#loadoverlay").fadeIn();  
 		   $("#processloading").fadeIn();	 			                    	                  
 	 	   $("#frmMaterialIssueList").attr("action","showMaterialIssueLst.jsf");   	                
 	       $("#frmMaterialIssueList").submit();
  	   }	  
   }
...
<form name="frmMaterialIssueList" id="frmMaterialIssueList" method="post" autocomplete="off">
  ...
  <div id="overlay" class="web_dialog_overlay"></div>
	...
	<table cellspacing="0" width="100%"  cellpadding="5" border="0" align="center"  style="height:10px">		      
	 ...
	 <table width="1000px" cellspacing="0" cellpadding="5" border="0" align="center"  style="height:25px">		      
	     <tr>  
	          <td width="30%" class="heading" align="left">&nbsp;Material Issue</td> 
		...
		<div style=" width: 1000px; padding:0px; margin: 0px;height:425;min-height:420px;">       
		 ...
		 <div style="width: 980px;background-color:white; border: 1px solid #E0E0E0;;">
		    ...
		    <table cellspacing="0" class="searchList" cellpadding="5" border="0" align="center">
		       <tr>
		          <td class="searchListLabel" align="left">Search&nbsp;&nbsp;<input type="text" name="issueNo" id="issueNo" placeholder="Enter Issue No"  class="textmediumlarge" autofocus maxlength="50"/>&nbsp;&nbsp;<input type="button" name="btnSearch" id="btnSearch" value="Go" class="btn btnSMImportant"></td>  
		       </tr>
		    </table>  
		    <table cellpadding="0" cellspacing ="0" border="0" align="center"  width="100%" >
			 <tr>
			        ...
			        <c:forEach items="${lstMaterialIssueDetail}" var="issueDetail" varStatus="row"> 
				           <tr>
				             ...
				             <td align="center" style="text-align:center;">${issueDetail.issuedBy}</td>
				              <c:set var="returned" value="${issueDetail.isReturned}"/>
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
							<%
							Integer returned = (Integer)pageContext.getAttribute("returned");
							if(returned != 1){
								%> 
									<a title="Click to Edit" id="editAnchor${row.index}" href="javascript:funedit('${issueDetail.issueNo}');"><img border="0" id="showedit" src="./images/pencil.png"/></a>&nbsp;
				             	<%
								 }else{
				             	%>
								...
								if(returned != 1){
								%>
				             	<a title="Click to Delete" href="javascript:fundelete('${issueDetail.issueNo}');" ><img border="0" src="./images/deleteicon.gif"/></a>&nbsp;
				             	<%
								}else{
				             	%>   
								...
								%>
				             	<a title="Click to View" id="viewReport${row.index}" href="javascript:viewReport('${issueDetail.issueNo}');"><img border="0" id="showedit" src="./images/view_report-icon.png"/></a>
				             	<%
								 }else{
				             	%>
