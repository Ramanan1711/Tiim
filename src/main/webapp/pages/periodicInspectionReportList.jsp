			...
			<table id="lstFieldTech" name="lstFieldTech" class="tableHeading">
			     ...
			     <tbody>
			         <c:forEach items="${lstPeriodicInspectionReport}" var="arlInspectionReport" varStatus="row">  
				          <tr>
				             <td>${arlInspectionReport.reportNo}</td>   
				             ...
				             <td align="center" style="text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;
				             	...
				             	<a title="Click to Delete" href="javascript:fundelete('${arlInspectionReport.reportNo}');" id="deleteAnchor${row.index}" ><img border="0"  id="delete${row.index}" style="" src="./images/deleteicon.gif"/></a>   		             					
				             </td>
				         </tr>
			         </c:forEach>
			     </tbody>       
